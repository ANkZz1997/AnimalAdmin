  ...
  return (
    <Root>
      ...
      <div className="admin_profile">
        <div className="click_menu" onClick={() => setToggle(!toggle)}>
          <BiMenu />
        </div>
        <div className="admin_details_notification">
          <div
            className="notification_point"
            onClick={() => {
              nevigate("/notification");
            }}
          >
            <IoIosNotifications />
          ...
          {accessCodes.includes("dashboard_code") ? (
            <div
              className="wallet_amount"
              onClick={() => setNotifyBalance(true)}
            >
              <span>
                <FaWallet />
              </span>
      ...
      <div
        className={toggle ? "toggle_on" : "toggle_off"}
